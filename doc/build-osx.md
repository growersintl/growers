...
Run:
  ./growersd --help  # for a list of command-line options.
Run
  ./growersd -daemon # to start the growers daemon.
Run
  ./growersd help # When the daemon is running, to get a list of RPC commands
