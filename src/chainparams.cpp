...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Growers Inc.";
        CTransaction txNew;
        txNew.nTime = 1495190475;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1495190475;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 3635121;
        ...
        // To compile in MinGW, as seen on:
        // https://github.com/nochowderforyou/clams/issues/293#issuecomment-245498359
...
public:
    CTestNetParams() {
        ...
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 53690;
      
        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x00002629e352f1ceb53a8adaff98abffc21d0cce29d7088d289c794f89dd619c"));
