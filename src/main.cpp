...
const string strMessageMagic = "Growers Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    int64_t nSubsidy = 0 * COIN;
        if(pindexBest->nHeight == 1)
        {
            ...
            nSubsidy = 1000420 * COIN; //  1.00420M COIN in first block
        } else {
            nSubsidy = 0;
        }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 10080) // ~week 1
    {
    nSubsidy = 0.1 * COIN;
    }
    else if(pindexBest->nHeight < 20160) // ~week 2
    {
    nSubsidy = 0.2 * COIN;
    }
    else if(pindexBest->nHeight < 30240) // ~week 3
    {
    nSubsidy = 0.3 * COIN;
    }
    else if(pindexBest->nHeight < 43200) // ~week 4
    {
    nSubsidy = 0.4 * COIN;
    }
    else if(pindexBest->nHeight < 50400) // ~week 5
    {
    nSubsidy = 0.5 * COIN;
    }
    else if(pindexBest->nHeight < 60480) // ~week 6
    {
    nSubsidy = 0.6 * COIN;
    }
    else if(pindexBest->nHeight < 70560) // ~week 7
    {
    nSubsidy = 0.7 * COIN;
    }
    else if(pindexBest->nHeight < 80640) // ~week 8
    {
    nSubsidy = 0.8 * COIN;
    }
    else if(pindexBest->nHeight < 90720) // ~week 9
    {
    nSubsidy = 0.9 * COIN;
    }
    else if(pindexBest->nHeight < 100800) // ~week 10
    {
    nSubsidy = 1 * COIN;
    }
    else if(pindexBest->nHeight < 110880) // ~week 11
    {
    nSubsidy = 1.1 * COIN;
    }
    else if(pindexBest->nHeight < 120960) // ~week 12
    {
    nSubsidy = 1.2 * COIN;
    }
    else if(pindexBest->nHeight < 131040) // ~week 13
    {
    nSubsidy = 1.3 * COIN;
    }
    else if(pindexBest->nHeight < 141120) // ~week 14
    {
    nSubsidy = 1.4 * COIN;
    }
    else if(pindexBest->nHeight < 151200) // ~week 15
    {
    nSubsidy = 1.5 * COIN;
    }
    else if(pindexBest->nHeight < 161280) // ~week 16
    {
    nSubsidy = 1.6 * COIN;
    }
    else if(pindexBest->nHeight < 171360) // ~week 17
    {
    nSubsidy = 1.7 * COIN;
    }
	else if(pindexBest->nHeight < 181440) // ~week 18
    {
    nSubsidy = 1.8 * COIN;
    }
    else
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    if (IsProofOfStake())
    {
        ...
        if (nStakeReward > nCalculatedStakeReward + (nCalculatedStakeReward * 0.03))
