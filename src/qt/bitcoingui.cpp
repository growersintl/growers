...
{
    resize(1024, 576);
	QFontDatabase::addApplicationFont(":/fonts/Cinzel");
	QFontDatabase::addApplicationFont(":/fonts/Amontillados");
    setWindowTitle(tr("Growers International") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
{
    QActionGroup *topToolbarTabGroup = new QActionGroup(this);
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Growers address"));
    ...
    aboutAction = new QAction(tr("&About Growers"), this);
    aboutAction->setToolTip(tr("Show information about Growers"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Growers"));
...
static QWidget* makeToolBarSpacer()
{
    ...
    spacer->setStyleSheet(fUseBlackTheme ? "QWidget { background-image: url(:/images/growers_text); background-position: bottom left; background-color: transparent; background-repeat: no-repeat; }" : "QWidget { background: none; }");
    return spacer;
}
...
void BitcoinGUI::createToolBars()
{
    ...
    if (fUseBlackTheme)
    {
        ...
        header->setFixedSize(160, 160);
        header->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        header->setStyleSheet("QWidget { background-image: url(:/images/header); background-position: top left; background-color: transparent; background-repeat: no-repeat; }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Growers client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Growers client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Growers network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Growers address or malformed URI parameters."));
    }
